...
class HumidityConversionWithIndex(torch.nn.Module):
    def __init__(self, input_index = None, hum_name = "B_Q", temp_name = "B_T", ps_name = "B_PS", file="/proj/gaia-climate/data/cam4_v3/rF_AMIP_CN_CAM4--torch-test.cam2.h1.1979-01-01-00000.nc" ):
        super().__init__()
